...
public:
	inline void initial(ModelParams& params, HyperParams& hyparams) {
		...
		action_state_concat.init(hyparams.action_feat_dim, -1);
		action_state_hidden.setParam(&(params.action_state_hidden));
		action_state_hidden.init(hyparams.action_state_dim, hyparams.dropProb);
		...
		app_state_represent.init(hyparams.app_dim, hyparams.dropProb);
		sep_state_represent.setParam(&params.sep_state_represent);
		sep_state_represent.init(hyparams.sep_dim, hyparams.dropProb);
		...
		bucket_action.init(hyparams.action_lstm_dim, -1);
	}
...
public:
	inline void forward(Graph* cg, const vector<CAction>& actions, AtomFeatures& atomFeat, PNode prevStateNode) {
		...
		PNode char_node_left_curr = (char_posi < atomFeat.char_size) ? (Node*) &(atomFeat.p_char_left_lstm->_hiddens[char_posi]) : (Node*)&bucket_char;
		PNode char_node_left_next1 = (char_posi + 1 < atomFeat.char_size) ? (Node*) &(atomFeat.p_char_left_lstm->_hiddens[char_posi + 1]) : (Node*)&bucket_char;
		PNode char_node_left_next2 = (char_posi + 2 < atomFeat.char_size) ? (Node*) &(atomFeat.p_char_left_lstm->_hiddens[char_posi + 2]) : (Node*)&bucket_char;
		PNode char_node_left_prev1 = (char_posi > 0) ? (Node*) &(atomFeat.p_char_left_lstm->_hiddens[char_posi - 1]) : (Node*)&bucket_char;
		PNode char_node_left_prev2 = (char_posi > 1) ? (Node*) &(atomFeat.p_char_left_lstm->_hiddens[char_posi - 2]) : (Node*)&bucket_char;

		PNode char_node_right_curr = (char_posi < atomFeat.char_size) ? (Node*) &(atomFeat.p_char_right_lstm->_hiddens[char_posi]) : (Node*)&bucket_char;
		PNode char_node_right_next1 = (char_posi + 1 < atomFeat.char_size) ? (Node*) &(atomFeat.p_char_right_lstm->_hiddens[char_posi + 1]) : (Node*)&bucket_char;
		PNode char_node_right_next2 = (char_posi + 2 < atomFeat.char_size) ? (Node*) &(atomFeat.p_char_right_lstm->_hiddens[char_posi + 2]) : (Node*)&bucket_char;
		PNode char_node_right_prev1 = (char_posi > 0) ? (Node*) &(atomFeat.p_char_right_lstm->_hiddens[char_posi - 1]) : (Node*)&bucket_char;
		PNode char_node_right_prev2 = (char_posi > 1) ? (Node*) &(atomFeat.p_char_right_lstm->_hiddens[char_posi - 2]) : (Node*)&bucket_char;
		...
		PNode char_lstm_left_start = atomFeat.word_start > 0 ? (Node *) &(atomFeat.p_char_left_lstm->_hiddens[atomFeat.word_start - 1]) : (Node *)&bucket_char;
		PNode char_lstm_left_end = char_node_left_prev1;

		PNode char_lstm_right_start = atomFeat.word_start >= 0 ? (Node *) &(atomFeat.p_char_right_lstm->_hiddens[atomFeat.word_start]) : (Node *)&bucket_char;
